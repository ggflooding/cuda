...
#define U_P (2.0)  //Physical inlet Velocity (m/s)
...
const double BLKRAD ((125 * 4) * BLOK * 0.5 / 0.092);  //how many node in radius
const double BLKCNTX[16]={250 ,250+59.788 ,250+59.788*2 ,250+59.788*3 ,250+59.788*4 ,250+59.788*5 ,250+59.788*6 ,250+59.788*7 \
						,250+59.788*8 ,250+59.788*9 ,250+59.788*10 ,250+59.788*11 ,250+59.788*12 ,250+59.788*13 \
						,250+59.788*14 ,250+59.788*15};
const double BLKCNTY[16]={59.788 ,NY-59.788 ,59.788 ,NY-59.788 ,59.788 ,NY-59.788 ,59.788 ,NY-59.788 ,59.788 ,NY-59.788 , \
...
__constant__ double dev_BLKRAD ((125*4) * BLOK * 0.5 / 0.092);  //how many node in radius
__constant__ double dev_BLKCNTX[16]={250 ,250+59.788 ,250+59.788*2 ,250+59.788*3 ,250+59.788*4 ,250+59.788*5 ,250+59.788*6 ,250+59.788*7 \
						,250+59.788*8 ,250+59.788*9 ,250+59.788*10 ,250+59.788*11 ,250+59.788*12 ,250+59.788*13 \
						,250+59.788*14 ,250+59.788*15};
__constant__ double dev_BLKCNTY[16]={59.788 ,NY-59.788 ,59.788 ,NY-59.788 ,59.788 ,NY-59.788 ,59.788 ,NY-59.788 ,59.788 ,NY-59.788 , \
						59.788 ,NY-59.788 ,59.788 ,NY-59.788 ,59.788 ,NY-59.788};
...
void Point_checkX_i(int t, double ux_i);
...
void Point_checkY_i(int t, double uy_i);
...
__global__ void dev_Point_checkX(attribute *domain, double *ux_a, double *ux_b, double *ux_c, double *ux_d, double *ux_e, double *ux_f, double *ux_g, double *ux_h, double *ux_i);
__global__ void dev_Point_checkY(attribute *domain, double *uy_a, double *uy_b, double *uy_c, double *uy_d, double *uy_e, double *uy_f, double *uy_g, double *uy_h, double *uy_i);
...
cudaError_t LBM(){
	...
	double *ux_i = (double*)malloc(sizeof(double));
	...
	double *uy_i = (double*)malloc(sizeof(double));
	
	double *err = (double*)malloc(sizeof(double));
	double *rhoav = (double*)malloc(sizeof(double));
	double *dev_err, *dev_rhoav;
	double *dev_ux_a, *dev_ux_b, *dev_ux_c, *dev_ux_d, *dev_ux_e, *dev_ux_f, *dev_ux_g, *dev_ux_h, *dev_ux_i;
	double *dev_uy_a, *dev_uy_b, *dev_uy_c, *dev_uy_d, *dev_uy_e, *dev_uy_f, *dev_uy_g, *dev_uy_h, *dev_uy_i;
...
cudaStatus = cudaMalloc((void**)&dev_ux_a, sizeof(double));
	...
	if (cudaStatus != cudaSuccess) goto Error;
	cudaStatus = cudaMalloc((void**)&dev_ux_i, sizeof(double));
	if (cudaStatus != cudaSuccess) goto Error;
	...
	if (cudaStatus != cudaSuccess) goto Error;
	cudaStatus = cudaMalloc((void**)&dev_uy_i, sizeof(double));
	if (cudaStatus != cudaSuccess) goto Error;
	...
	for (int t = 0;; t++){
		...
		cudaStatus = cudaMemcpy(ux_i, dev_ux_i, sizeof(double), cudaMemcpyDeviceToHost);
		if (cudaStatus != cudaSuccess) goto Error;
		...
		cudaStatus = cudaMemcpy(uy_i, dev_uy_i, sizeof(double), cudaMemcpyDeviceToHost);
		if (cudaStatus != cudaSuccess) goto Error;
